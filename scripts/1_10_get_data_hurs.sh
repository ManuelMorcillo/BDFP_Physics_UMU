...
# dirout='/diskonfire/ERA5/daily_values/hurs/'
# cd $dirout
...
EOF
               ...
               sed -f kk4sed 1_11_download-cds-era5-4sed.py > download_cds_era5_${var}.py
               rm kk4sed
...
# Calculate the daily mean of RH
cdo -b F32 daymean hourly_rh_${year}${month}${day}.nc daily_rh_${year}${month}${day}.nc

# Regrid the daily mean RH to 1-degree resolution in GRIB format
cdo -b F32 remapbil,~/Dropbox/model/fire_database/source/griddes.txt daily_rh_${year}${month}${day}.nc rhmean_${year}${month}${day}_1degree.nc

cdo chname,es_td,rhmean rhmean_${year}${month}${day}_1degree.nc ofile.nc
mv ofile.nc rhmean_${year}${month}${day}_1degree.nc
rm *tas* *td* *_rh*
 done
